...
function customTransition() {
    return new Promise((resolve) => {
        ...
        // Step 1: Close curtains and show loader (0.2s)
        ...
        // Step 2: Wait for 1.5s with loader active
        setTimeout(() => {
            // Step 3: Open curtains and hide loader (0.2s)
        ...
        }, 2500); // Total: 0.2 + 1.5 + 0.8 = 2.5s, adjusted to 3s total
    });
}
...
async function beginGame() {
    ...
    // Run custom transition for 3 seconds
    await customTransition();
    
    // Then continue with the street scene
    startDialogue();
}
...
function startDialogue() {
    ...
    }, 1000); // Reduced timeout since we don't need to wait for airplane animation
}
